    ...
    <div class="container d-flex justify-content-center" >
        <figure class="card card-product-grid card-lg"> <a href="#" class="img-wrap" data-abc="true"> <img src="{{ url('/uploads/'.$musicpad->image) }}"> </a>
            <figcaption class="info-wrap">
                <div class="row">
                    <div class="col-md-9 col-xs-9"> <a href="#" class="title" data-abc="true">{{ $musicpad->name }}</a> <span class="rated" style="font-size: 15px">{{ $musicpad->location }}</span> </div>
                    <div class="col-md-3 col-xs-3">
                        <div class=" text-right" style="font-size: 15px"> {{ $musicpad->phone }} </div>
                    </div>
                </div>
            </figcaption>
